...
<head>
    ...
    <title>Care Plan List Dashboard | DocuCare</title>
...
<body>
    ...
    <main class="main">
        <header>
            <h1>Patient Care Plans Dashboard</h1>
        </header>
                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<tr>
                                    ...
                                    <td>
                                        <input type="button" name="info" value="View Info" class="btn" onclick="window.location.href=\'infoCarePlans.php?Patient_ID='.$Patient_ID.'\'">
                                        <button class="btn-icon" onclick="window.location.href=\'infoCarePlans.php?Patient_ID='.$Patient_ID.'\'">
