...
<head>
    ...
    <title>Progress Note List Dashboard | DocuCare</title>
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<tr>
                                ...
                                <td>
                                    <input type="button" name="info" value="View Info" class="btn" onclick="window.location.href=\'infoProgressNote.php?Patient_ID='.$Patient_ID.'\'">
                                    <button class="btn-icon" onclick="window.location.href=\'infoProgressNote.php?Patient_ID='.$Patient_ID.'\'">
