        ...
        <section class="profile-container">
            <div class="patient-profile">
                ...
                <div class="profile-info">
                    <div class="patient-details">
                        ...
                        <p><strong>Name:</strong> <span id="Name"><?php echo htmlspecialchars ($patient['Patient_Name']); ?></span></p>
                        ...
                        <p><strong>Address:</strong> <span id="Address"><?php echo htmlspecialchars ($patient['Address']);?></span></p>
            ...
            <div class="info-btn">
                <ul>
                    ...
                    <li><a href="medRecord.php">Medication Record</a></li>
                </ul>
            </div>
        </section>
    </main>
