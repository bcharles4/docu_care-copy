...
<head>
    ...
    <title>Nurse Scheduling List Dashboard | DocuCare</title>
...
<body>
    ...
    <main class="main">
        <header>
            <h1>Nurse Schedule Dashboard</h1>
        </header>

        <section class="search">
            <a href="#" class="search-icon"><i class="fas fa-search"></i></a>
            <input type="text" id="searchInput" placeholder="Search patient or nurse name" >   
            <a href="addNurseSched.php" class="btn-2">Add Nurse Sched</a>   
        </section>
        ...
        <section class="search-result">
            ...
            <div class="box-container" id="patient_infoList">
                ...
                <?php
                include('mycon.php');
                $sql = "SELECT * FROM nurse_sched";
                $result = $connection->query($sql);
                echo "<table border='1' width='100%'>";
                echo "<tr align='center' class=tblheader>
                        <td><b>Patient ID</b></td>
                        <td><b>Day Shift Nurse ID</b></td>
                        <td><b>Night Shift Nurse ID</b></td>
                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$row['Day_Shift_Nurse_ID'].'</td>
                                    <td>'.$row['Night_Shift_Nurse_ID'].'</td>     
                                    <td>
                                        <input type="button" name="info" value="View Info" class="btn" onclick="window.location.href=\'infoNurseSched.php?Patient_ID='.$Patient_ID.'\'">
                                        <button class="btn-icon" onclick="window.location.href=\'infoNurseSched.php?Patient_ID='.$Patient_ID.'\'">
