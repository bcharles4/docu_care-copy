...
<body>
    ...
    <main class="main">
        ...
        <section class="search">
            ...
            <input type="text" id="searchInput" placeholder="Search room ID" >   
            <a href="addRoomManage.php" class="btn-2">Add Room</a>   
        </section>
        ...
        <section class="search-result">
            ...
            <div class="box-container" id="patient_infoList">
                ...
                <?php
                include('mycon.php');
                $sql = "SELECT * FROM rooms_information";
                    ...
                    while ($row = $result->fetch_assoc()) {
                     $Patient_ID = $row['Patient_ID'];
                       echo '<tr>
                               ...
                               <td>
                                 <input type="button" name="info" value="View Info" class="btn" onclick="window.location.href=\'infoRoomManage.php?Patient_ID='.$Patient_ID.'\'">
                                    <button class="btn-icon" onclick="window.location.href=\'infoRoomManage.php?Patient_ID='.$Patient_ID.'\'">
