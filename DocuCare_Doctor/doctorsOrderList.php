        ...
        <section class="search-result">
            ...
            <div class="box-container" id="patient_infoList">
                ...
                echo "<tr align='center' class=tblheader>
                        ...
                        <td class='no-print'><b>Discharge</b></td>
                      </tr>";

                if (is_array($PatientInfoArray) && count($PatientInfoArray) > 0) {
                  foreach ($PatientInfoArray as $Patient) {
                      ...
                      $patientType = $Patient['Patient_Type'];
                        ...
                        echo'<tr>
                                ...
                                <td>
                                    <input type="button" name="info" value="Discharge" class="btn-3" 
                                        onclick="return confirm(\'Are you sure you want to discharge this patient?\') ? (window.location.href=\'Queries.php?act=Discharge&Patient_ID='.$Patient_ID.'\') : false;">
