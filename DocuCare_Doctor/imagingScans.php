              ...
              <?php if($Position == 'Doctor') { ?>
                <div class="form-row-container">
                    ...
                    <?php
                        ...
                        if (!empty($ScanInfo)) {
                            foreach ($ScanInfo as $fetch) {
                    ?>
                        <div class="ResultImage">
                            <a href="<?php echo htmlspecialchars($fetch['Image_Location']); ?>" class="image-container">
                                <img src="<?php echo htmlspecialchars($fetch['Image_Location']); ?>" alt="Scan Result" />
                            </a>
                    ...
                    <?php 
                            ...
                            echo "<p class='no-data'>No scan results found for this patient.</p>";
                        }
                    ?>
                </div>
              <?php } ?>
