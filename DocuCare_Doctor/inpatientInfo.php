      ...
      <?php if($Position == 'Doctor') { ?>
            <div class="info-btn">
                <ul>
                    ...
                    <li><a href="standingOrder.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">Standing Order</a></li>
                    <li><a href="medRecord.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">Medication Record</a></li>
                    <li><a href="kardex.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">Kardex</a></li>
                    <li><a href="tprChart.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">TPR Graphic Chart</a></li>
                    <li><a href="vitalsign.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">Vital Signs Monitoring</a></li>
                    <li><a href="intakeOutput.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">24 Hours Intake and Output Record</a></li>
                    <li><a href="ivRecord.php?Patient_ID=<?php echo $TargetPatient_ID; ?>">Intravenous Fluid Record</a></li>  
